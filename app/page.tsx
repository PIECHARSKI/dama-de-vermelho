          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-left">
              ...
              <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 mb-8">
                ...
                <Button className="bg-red-600 hover:bg-red-700 text-white px-8 py-6 text-lg rounded-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(220,38,38,0.4)]">
                  QUERO ESSE PODER AGORA
                </Button>
              </div>
            </div>

            {/* Vídeo à direita com efeito de borda estilizada */}
            <div className="h-[600px] relative">
              ...
              {/* Efeito de brilho vermelho atrás do vídeo */}
              <div
                className="absolute inset-0 bg-gradient-radial from-red-900/20 via-transparent to-transparent z-0 animate-glow-pulse"
                style={{ filter: "blur(60px)" }}
              ></div>

              {/* Container do vídeo com efeito glassmorphism */}
              <div className="relative h-full z-10 backdrop-blur-sm bg-black/10 rounded-2xl overflow-hidden">
                <VideoPlayer className="h-full w-full" />

                {/* Efeito de brilho vermelho nas bordas */}
                <div
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl p-8 max-w-xl mx-auto">
              ...
              <Button className="bg-red-600 hover:bg-red-700 text-white px-8 py-6 text-lg rounded-full w-full transition-all duration-300 hover:shadow-[0_0_20px_rgba(220,38,38,0.4)]">
                QUERO TER ESSE PODER AGORA
              </Button>
